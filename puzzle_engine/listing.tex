...
\title{Example Solution}
\author{Marius Mikučionis}
\begin{document}
\maketitle
\lstinputlisting[style=colorBash,caption={CMakeLists.txt}]{./CMakeLists.txt}
\lstinputlisting[style=colorC++,caption={family.cpp}]{./family.cpp}
\lstinputlisting[style=colorC++,caption={crossing.cpp}]{./crossing.cpp}
\lstinputlisting[style=colorC++,caption={frogs.cpp}]{./frogs.cpp}
\end{document}
